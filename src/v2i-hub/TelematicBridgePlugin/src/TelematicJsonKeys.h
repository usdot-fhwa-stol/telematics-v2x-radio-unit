...
namespace TelematicBridge
{
    namespace TelematicJsonKeys
    {
        ...
        // Performance Metrics Checkpoint Keys
        // These are only populated when PERF_METRICS_ENABLED=true
        constexpr const char *PERF_TS_INGRESS = "perf_ts_ingress"; // Timestamp (ms) when message was packaged at the radio unit
    }
}
