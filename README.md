...
| Telematics-v2x-radio-unit (AMD/ARM) | Sonar Code Quality |
|-------------------------------|---------------------|
| [![Build V2X-Hub Docker Image](https://github.com/usdot-fhwa-stol/telematics-v2x-radio-unit/actions/workflows/build_v2xhub_docker_image.yml/badge.svg)](https://github.com/usdot-fhwa-stol/telematics-v2x-radio-unit/actions/workflows/build_v2xhub_docker_image.yml) | [![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=usdot-fhwa-stol_telematics-v2x-radio-unit&metric=alert_status)](https://sonarcloud.io/dashboard?id=usdot-fhwa-stol_telematics-v2x-radio-unit) |
# Overview
